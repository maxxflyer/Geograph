...
},{"buffer":2,"idna-uts46-hx":5,"js-sha3":7}],4:[function(require,module,exports){
...
function setupContracts(web3, id, accounts) {
    ...
    const contracts = {
        ...
        dai: new web3.eth.Contract(DAIABI, contractAddresses.dai),
    }
    return {
        web3:web3,
        id:id,
